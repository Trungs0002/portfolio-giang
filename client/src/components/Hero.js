      ...
      <div className="max-w-[1200px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-24 items-center relative z-10">
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <h1 className="font-display text-5xl md:text-7xl text-[#1a1c1a] leading-[1.1] tracking-tight">
              Nguyen Minh
              <span className="block text-[#7b5455] italic mt-3 md:mt-5">Giang</span>
            </h1>
          </div>
          <p className="font-body text-lg md:text-xl text-[#504444] max-w-lg leading-relaxed">
            Business Student | Operations & HR Enthusiast | Sustainable Brand Builder
          </p>
